...
const timeZonesAfrica = timeZonesAll.filter(timeZone => timeZone.startsWith('Africa/'));

// Filter time zones of America only
const timeZonesAmerica = timeZonesAll.filter(timeZone => timeZone.startsWith('America/'));

// Filter time zones of Antarctica only
const timeZonesAntarctica = timeZonesAll.filter(timeZone => timeZone.startsWith('Antarctica/'));

// Filter time zones of Arctic only
const timeZonesArctic = timeZonesAll.filter(timeZone => timeZone.startsWith('Arctic/'));

// Filter time zones of Asia only
const timeZonesAsia = timeZonesAll.filter(timeZone => timeZone.startsWith('Asia/'));

// Filter time zones of Atlantic only
const timeZonesAtlantic = timeZonesAll.filter(timeZone => timeZone.startsWith('Atlantic/'));

// Filter time zones of Australia only
const timeZonesAustralia = timeZonesAll.filter(timeZone => timeZone.startsWith('Australia/'));

// Filter time zones of Europe only
const timeZonesEurope = timeZonesAll.filter(timeZone => timeZone.startsWith('Europe/'));

// Filter time zones of Indian only
const timeZonesIndian = timeZonesAll.filter(timeZone => timeZone.startsWith('Indian/'));

// Filter time zones of Pacific only
const timeZonesPacific = timeZonesAll.filter(timeZone => timeZone.startsWith('Pacific/'));
